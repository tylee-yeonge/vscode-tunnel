...
# BASE_IMAGE=nvidia/cuda:12.4.1-cudnn-devel-ubuntu24.04   # CUDA 학습 환경
...
| `BASE_IMAGE` | `ubuntu:24.04` | 빌드 베이스 이미지. CUDA 사용 시 `nvidia/cuda:12.4.1-cudnn-devel-ubuntu24.04` 권장 |
...
| 용도 | 권장 이미지 |
|------|-----------|
| 학습/추론 (Phase 3/4) | `nvidia/cuda:12.4.1-cudnn-devel-ubuntu24.04` |
| 추론 전용 | `nvidia/cuda:12.4.1-cudnn-runtime-ubuntu24.04` |
